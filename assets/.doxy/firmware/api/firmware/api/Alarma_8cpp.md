...
[**FileList**](files.md) **>** [**firmware**](dir_d9edf6c004b4a7ff14fe9ae7a92214ee.md) **>** [**Alarma.cpp**](Alarma_8cpp.md)

[Go to the source code of this file](Alarma_8cpp_source.md)

_Implementation of functions for alarm management and data averaging._ [More...](#detailed-description)
...
| Type | Name |
| ---: | :--- |
|  void | [**imprimir\_hora**](#function-imprimir_hora) (void) <br>_Prints the current time to the serial port (for debugging)._  |
...
### function imprimir\_hora 

_Prints the current time to the serial port (for debugging)._ 
```C++
static inline void imprimir_hora (
    void
) 
```
