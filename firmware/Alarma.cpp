...
#undef DEBUG_LEVEL
#define DEBUG_LEVEL DEBUG_ALARMA  //!< Redefinición del nivel de depuración de este archivo fuente.
#define DEBUG_TAG "ALARMA"        //!< Etiqueta al enviar mensajes de depuración.

/**
 * @defgroup  gVarGlobales  Variables globales
 * @details   Definición y asignación de memoria de las variables globales utilizadas por otros 
 * módulos.
 * @{
 */
/**
...
void rtc_alarma_inicializar(void) {
  ...
  if (rtc.lostPower()) {
    DEBUG_WARN("RTC: alimentación auxiliar perdida. Estableciendo fecha/hora a la de compilación");
